function nicomonkey_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
nicomonkey_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				nicomonkey_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
nicomonkey_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
nicomonkey_xmlhttpRequester.prototype.setupRequestEvent =
